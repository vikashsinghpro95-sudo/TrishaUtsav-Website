<?php
/**
 * Database Migration Script for Delhivery Integration
 * Adds tracking_id, tracking_status, delhivery_pincode_verified, estimated_delivery_days to orders table safely
 */
