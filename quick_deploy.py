...
FILES = {
    ...
    "admin/assets/js/utils.js":             "admin/assets/js/utils.js",
    ...
    "includes/EkartService.php":            "includes/EkartService.php",
    ...
    "update_schema_ekart.php":              "update_schema_ekart.php",
    "public/update_schema_ekart.php":       "public/update_schema_ekart.php",
