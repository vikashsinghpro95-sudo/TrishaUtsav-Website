...
<div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div>
        <div class="flex items-center gap-2 mb-2">
            <a href="/admin/orders" class="text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors">
...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8 pb-12">
    ...
    <div class="xl:col-span-1 space-y-6">
        ...
        <!-- Ekart Express Logistics & Tracking Card -->
        <div class="bg-white dark:bg-slate-850 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
            <div class="px-5 py-4 border-b border-slate-200 dark:border-slate-800 bg-amber-50/60 dark:bg-amber-950/20 flex items-center justify-between">
                <h3 class="text-base font-semibold text-slate-900 dark:text-white flex items-center">
                    <i class="ph ph-package mr-2 text-amber-600"></i> Ekart Express Logistics
                </h3>
                <span class="text-[10px] font-bold uppercase tracking-wider text-amber-700 bg-amber-100 dark:bg-amber-900/40 px-2 py-0.5 rounded-full">Ekart Express</span>
            </div>
            ...
            <div class="p-5 space-y-4">
                <div>
                    ...
                    <div class="flex gap-2">
                        <input type="text" id="admin-delhivery-waybill" placeholder="e.g. EKART12345678" class="block w-full px-3 py-2 border border-slate-300 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500 sm:text-sm font-mono">
